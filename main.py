import urllib2 , cookielib , random , re , sys , socket , time , httplib , ssl
       ...
       # Team   : Bl4CK - H4MM3R.              #
       # Date   : 29 - March - 2019.           #
       # Github : https://github.com/M4uLFake. #
       #########################################
...
if __name__ == "__main__":
	print ("       "+Y+"")
	print (R+"[+] Admin :@M4uL     "+Y+"")
	print (R+"[+] Github : Github.com/M4uLFake "+Y+"")
	print (R+"[+] Thanks For Using My Script :*  "+Y+"")
	print (W+43*"-")

	inurl = raw_input(B+"[+]"+G+" M4ul@localhost    "+W+": ")
	site  = raw_input(B+"[+]"+G+" M4ul@localhost     "+W+": ")
	maxc  = raw_input(B+"[+]"+G+" M4ul@localhost "+W+": ")
